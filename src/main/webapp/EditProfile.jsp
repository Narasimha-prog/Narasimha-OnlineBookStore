            ...
            <div class="card-body">
                ...
                <form action="updatec" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="addr" name="addr" value="<%= ub.getAddr() %>">
                    </div>

                    <div class="mb-3">
                        <label for="mid" class="form-label">Mail ID</label>
                        <input type="email" class="form-control" id="mid" name="mid" value="<%= ub.getmId() %>">
                    </div>

                    <div class="mb-3">
                        <label for="phno" class="form-label">Phone Number</label>
                        <input type="text" class="form-control" id="phno" name="phno" value="<%= ub.getPhNo() %>">
                    </div>
